...
function Hero() {
    return (
      <div className="container mt-5">
        <div className="row mt-5 text-center mb-5 p-3">
          <h1 className="mt-5 fs-4 mb-5">
        ...
        <div className="row mt-5 border-top  text-muted p-3">
          <div className="col-6 mt-5 mb-5 p-5 fs-6">
            <p style={{ marginLeft: "150px", lineHeight: "2" }}>
          ...
          <div className="col-6 mt-5 mb-5 p-5 fs-6">
            <p style={{ marginRight: "150px", lineHeight: "2" }}>
